			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<table id="datatablePenilaianKinerjaPns" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
...
<script>
	var datatable = $('#datatablePenilaianKinerjaPns').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/Penilaian_kinerja_pns/get_data', {
			...
			.then(function (response) {
				...
				$.each(response, function (key, value) {
					...
					// if (_updated == 1) {
					// 	arrAksi += '<a href="' + base_url + '/dashboard/kinerja_pns_bawahan/index?id_encrypt=' + value
					// 		.id_encrypt +
