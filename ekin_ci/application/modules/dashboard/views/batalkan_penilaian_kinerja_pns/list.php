			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<table id="datatableBatalkanPenilaianKinerjaPns" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
                                    ...
                                    <th colspan="3" class="text-center">Jumlah Pekerjaan</th>
                                ...
                                <tr>
                                    <th colspan="0" class="text-center">Belum Diverifikasi</th>
...
<script>
	var datatable = $('#datatableBatalkanPenilaianKinerjaPns').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/Batalkan_penilaian_kinerja_pns/get_data', {
			...
			.then(function (response) {
				...
				$.each(response, function (key, value) {
					...
					if (_updated == 1) {
						arrAksi += '<a href="' + base_url + '/dashboard/batalkan_kinerja_pns_bawahan/index?id_encrypt=' + value
							.id_encrypt +
