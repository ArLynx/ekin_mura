			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<table id="datatableBawahan" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
...
<script>
	var datatable = $('#datatableBawahan').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/bawahan/get_data', {
			...
			.then(function (response) {
				...
				$.each(response, function (key, value) {
					...
					if (_updated == 1) {
						arrAksi += '<a href="' + base_url + '/dashboard/kinerja_bawahan/index?id_encrypt=' + value
							.id_encrypt +
