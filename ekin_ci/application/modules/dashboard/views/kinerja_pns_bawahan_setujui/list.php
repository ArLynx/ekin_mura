			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<table id="datatableKegiatanKinerjaBwhSetujui" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
									<th>No</th>
									<th>Waktu Kerja</th>
...
<script>
	var datatable = $('#datatableKegiatanKinerjaBwhSetujui').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
        ...
        $.get(base_url + '/dashboard/kinerja_pns_bawahan_setujui/get_data', {
			...
			.then(function (response) {
				...
				$.each(response, function (key, value) {
					...
					if (arrAksi != '') {
						...
						arrData.push(value.komentar_penilai);
	...
	$(".save-edit-tolak").click(function() {
        ...
        $.get(base_url + '/api/save_edit_tolak_setujui_penilai', {
