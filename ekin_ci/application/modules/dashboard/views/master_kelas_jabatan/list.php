	...
	<div class="box">
		<div class="box-header with-border">
			<div class="row">
				...
				<div class="col-md-4">
					<?php if ($_created == 1): ?>
						<a href="#" id="addLinkKJ" class="btn btn-primary">Tambah</a>
					<?php endif;?>
				</div>
			</div>
		</div>
...
<script>
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/master_kelas_jabatan/get_data', {
			...
			.then(function (response) {
				...
				if(response != '') {
					...
					$.each(response, function (key, value) {
						...
						// if (_updated == 1) {
						if (1 == 1) {
							arrAksi += '<a href="' + base_url + '/dashboard/master-kelas-jabatan/edit/' + value
	...
	function deleteData(id_encrypt) {
		...
		swalWithBootstrapButtons.fire({
			...
			if (result.value) {
				$.get(base_url + "/dashboard/master_kelas_jabatan/delete", {
