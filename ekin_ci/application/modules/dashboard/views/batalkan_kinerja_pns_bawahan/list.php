		...
		<div class="box-body" style="padding-top: 0;">
			<div class="row">
				<div class="col-md-12">
					...
					<form id="fromTanggapanKeg" action="<?php echo base_url('/dashboard/batalkan_kinerja_pns_bawahan/batalkan-tanggapan-all-kegiatan-penilai'); ?>" method="post">
						<?php alert_message_dashboard();?>
						<table id="datatableBatalKegiatanKinerjaBwh" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
									<th>No</th>
									<th>Waktu Kerja</th>
...
<script>
	var datatable = $('#datatableBatalKegiatanKinerjaBwh').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/batalkan_kinerja_pns_bawahan/get_data', {
	...
	var table = $('#datatableBatalKegiatanKinerjaBwh').DataTable();
