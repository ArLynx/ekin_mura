			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<table id="datatableKegiatanKinerjaBwhTolak" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
									<th>No</th>
									<th>Waktu Kerja</th>
...
<script>
	var datatable = $('#datatableKegiatanKinerjaBwhTolak').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
        ...
        $.get(base_url + '/dashboard/kinerja_pns_bawahan_ditolak/get_data', {
