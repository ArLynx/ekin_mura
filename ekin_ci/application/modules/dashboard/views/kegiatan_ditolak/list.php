...
<script>
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/kegiatan_ditolak/get_data', {
			...
			.then(function (response) {
				...
				$.each(response, function (key, value) {
					...
					arrData = [
                        ...
                        value.nama_kegiatan,
                        value.output,
						// value.status == 4 ? value.komentar_atasan : value.komentar_penilai,
					];
					...
					arrData.push(value.status == 4 ? value.komentar_atasan : value.komentar_penilai);
