		...
		<div class="box-body" style="padding-top: 0;">
			<div class="row">
				<div class="col-md-12">
					...
					<form id="fromTanggapanKegKoreksi" action="<?php echo base_url('/dashboard/kinerja_bawahan_koreksi/tanggapan-all-kegiatan'); ?>" method="post">
						<?php alert_message_dashboard();?>
						<table id="datatableKegiatanBwhKoreksi" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
									<th>No</th>
									<th>Waktu Kerja</th>
									...
									<th>Aksi</th>
									<th>
										<button class="btn btn-sm btn-success btncheckboxsetuju" type="submit" style="height:22px" title="Setuju" value="1">
                            			<i class="fa fa-check-circle" style="position: absolute; margin:-6px 0px 0px -5px;"></i></button><br />
										<button class="btn btn-sm btn-danger btncheckboxtolak" type="submit" style="height:22px" title="Tolak" value="4">
                ...
                <div class="card">
                    <div class="card-body">
                        <span class="origin-form">
							...
							<div class="form-group row">
                                <label class="col-md-3 col-form-label">Komentar Anda</label>
                                <div class="col-md-9">
									<table>
										<tr>
											<td width="5px">:&nbsp;</td>
...
<script>
	var datatable = $('#datatableKegiatanBwhKoreksi').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
        ...
        $.get(base_url + '/dashboard/kinerja_bawahan_koreksi/get_data', {
		...
		$.get(base_url + '/api/get_kinerja_bawahan_setujui_byid', {
            ...
            .then(function(response) {
                $.each(response, function(key, value) {
					...
					$("#textKA").text(value.komentar_atasan);
                });
            })
	...
	$(".save-edit-setujui").click(function() {
        ...
        $.get(base_url + '/api/save_edit_setujui_koreksi', {
	...
	$(".save-edit-koreksi").click(function() {
        ...
        $.get(base_url + '/api/save_edit_koreksi_koreksi', {
			id_kegiatan: id_kegiatan,
	...
	$(".save-edit-tolak").click(function() {
        ...
        $.get(base_url + '/api/save_edit_tolak_koreksi', {
			id_kegiatan: id_kegiatan
        })
	...
	$(document).on('click', '.btncheckboxsetuju', function(e) {
		...
		Swal.fire({
			...
			if (result.value) {
				$('#fromTanggapanKegKoreksi').submit();
            } else if (
