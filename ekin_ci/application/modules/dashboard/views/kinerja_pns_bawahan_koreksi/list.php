		...
		<div class="box-body" style="padding-top: 0;">
			<div class="row">
				<div class="col-md-12">
					...
					<form id="fromTanggapanKegKoreksi" action="<?php echo base_url('/dashboard/kinerja_pns_bawahan_koreksi/tanggapan-all-kegiatan-penilai'); ?>" method="post">
						<?php alert_message_dashboard();?>
						<table id="datatableKegiatanKinerjaBwhKoreksi" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
									<th>No</th>
									<th>Waktu Kerja</th>
...
<script>
	var datatable = $('#datatableKegiatanKinerjaBwhKoreksi').DataTable({
		"columns": [{
				"width": "1"
			},
			{
	...
	function getData() {
        ...
        $.get(base_url + '/dashboard/kinerja_pns_bawahan_koreksi/get_data', {
	...
	$(".save-edit-setujui").click(function() {
        ...
        $.get(base_url + '/api/save_edit_setujui_koreksi_penilai', {
	...
	$(".save-edit-koreksi").click(function() {
        ...
        $.get(base_url + '/api/save_edit_koreksi_koreksi_penilai', {
			id_kegiatan: id_kegiatan,
	...
	$(".save-edit-tolak").click(function() {
        ...
        $.get(base_url + '/api/save_edit_tolak_koreksi_penilai', {
			id_kegiatan: id_kegiatan
        })
