			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						<table id="datatableRTG" class="table table-striped table-bordered" style="width: 100%;">
							<thead>
								<tr>
									<th>No</th>
									<th>SOPD</th>
...
<script>
	var datatable = $('#datatableRTG').DataTable({
		"columns": [{
				"width": "10"
			},
			null,
	...
	function getData() {
		...
		$.get(base_url + '/dashboard/rekap_tpp_gabungan/get_data', {
	...
	function deleteData(unor_encrypt) {
		...
		swalWithBootstrapButtons.fire({
			...
			if (result.value) {
				...
				$.get(base_url + "/dashboard/rekap_tpp_gabungan/delete", {
