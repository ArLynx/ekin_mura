...
class Batalkan_kinerja_pns_bawahan extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Batalkan Kinerja Pns Bawahan';
        $this->auth       = false;
    }
    ...
    public function index()
    {
        ...
        $data['breadcrumb'] = [
            ['link' => '', 'title' => 'Batalkan Kinerja Pns Bawahan', 'icon' => '', 'active' => '1'],
        ];
        ...
        $this->render('batalkan_kinerja_pns_bawahan/list', $data);
    }
    ...
    public function batalkan_tanggapan_all_kegiatan_penilai()
    {
        ...
        redirect("/dashboard/batalkan_kinerja_pns_bawahan/index?id_encrypt=$id_cry");
    }
