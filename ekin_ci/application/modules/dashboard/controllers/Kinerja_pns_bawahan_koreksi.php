...
class Kinerja_pns_bawahan_koreksi extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Kinerja Pns Bawahan Koreksi';
        $this->auth       = false;
    }
    ...
    public function index()
    {
        ...
        $this->render('kinerja_pns_bawahan_koreksi/list', $data);
    }
    ...
    public function tanggapan_all_kegiatan_penilai()
    {
        ...
        redirect("/dashboard/kinerja_pns_bawahan_koreksi/index?id_encrypt=$id_cry");
    }
