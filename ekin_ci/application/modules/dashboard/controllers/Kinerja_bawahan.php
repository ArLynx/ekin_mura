...
class Kinerja_bawahan extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Kinerja Bawahan Belum Diperiksa';
        $this->auth       = false;
    }
    ...
    public function index()
    {
        ...
        $this->render('kinerja_bawahan/list', $data);
    }
    ...
    public function tanggapan_all_kegiatan()
    {
        ...
        redirect("/dashboard/kinerja_bawahan/index?id_encrypt=$id_cry");
    }
