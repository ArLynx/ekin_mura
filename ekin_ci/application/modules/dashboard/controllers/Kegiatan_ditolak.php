...
class Kegiatan_ditolak extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Kegiatan Ditolak';
        $this->auth       = false;
    }
    ...
    public function index()
    {
        ...
        $data['breadcrumb'] = [
            ['link' => '', 'title' => 'Kegiatan Ditolak', 'icon' => '', 'active' => '1'],
        ];
        ...
        $this->render('kegiatan_ditolak/list', $data);
    }
