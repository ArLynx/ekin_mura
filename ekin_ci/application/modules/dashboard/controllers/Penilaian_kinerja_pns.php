...
class Penilaian_kinerja_pns extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Rekap Penilaian Kinerja PNS';
    }
    ...
    public function get_data()
    {
        ...
        // $data = $this->bawahan_model->get_bawahan_list($year, $month, $nip, $unor, $limit, $offset, $like);
    ...
    public function index()
    {
        ...
        $data['breadcrumb'] = [
            ['link' => '', 'title' => 'Penilaian Kinerja PNS', 'icon' => '', 'active' => '1'],
        ];
        ...
        $this->render('penilaian_kinerja_pns/list', $data);
    }
