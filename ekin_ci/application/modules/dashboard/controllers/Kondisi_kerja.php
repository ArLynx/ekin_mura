...
class Kondisi_kerja extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Master Kondisi Kerja';
    ...
    public function index()
    {
        ...
        $data['active_menu'] = 'master';
            ...
            // $requireOption = [
            //     'method'      => 'GET',
            //     'url'         => $this->svc . "api/kondisi_kerja",
            //     'headers'     => [
            ...
            //     'returnArray' => true,
            // ];
            // $data['kondisi_kerja1'] = $this->makeRequest($requireOption);
            //   if ($this->input->get()) {
            ...
            $data['headers'] = get_session('auth_token');
            
        $selected_year = $this->input->get('selected_year', true);
        $data['selected_year'] = $selected_year;

        $this->render('kondisi_kerja/list', $data);
    }
       ...
       public function ajaxHandler() {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            // Do something with the data (you might want to validate and process it)
            $result = $this->Your_model->processData($key1, $key2);
            ...
            // Non-AJAX requests can be redirected or handled differently
            show_404();
        }
    }
    ...
    public function add()
{
    ...
    $kondisi_id = $this->input->post('kondisi_id', true);
    ...
    $requireOption = [
                    'method'      => 'PUT',
                    'url'         => $this->svc . "api/kondisi_kerja/" . $kondisi_id,
                    'headers'     => [
                        'Authorization' => get_session('auth_token'),
                    ],
                    'body'        => [
  ...
  $this->session->set_flashdata('message', ['message' => 'Input Berhasil..', 'class' =>  'alert-success' ]);
                  ...
                  redirect('dashboard/kondisi_kerja?selected_year=' . urlencode($data['selected_year']));
    ...
    public function delete()
{
    ...
    $kondisi_id = $this->input->post('kondisi_id_delete', true);
    ...
    $requireOption = [
                ...
                $save = $this->makeRequest($requireOption);
                   ...
                   redirect('dashboard/kondisi_kerja');
            }
