...
class Batalkan_penilaian_kinerja_pns extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->page_title = 'Batalkan Penilaian Kinerja PNS';
        $this->auth       = false;
    }
    ...
    public function index()
    {
        ...
        $data['breadcrumb'] = [
            ['link' => '', 'title' => 'Batalkan Penilaian Kinerja PNS', 'icon' => '', 'active' => '1'],
        ];
        ...
        $this->render('batalkan_penilaian_kinerja_pns/list', $data);
    }
